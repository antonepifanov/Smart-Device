...
/* harmony import */ var _modules_init_popup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-popup */ "./js/modules/init-popup.js");
/* harmony import */ var _modules_init_accordeon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-accordeon */ "./js/modules/init-accordeon.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_init_popup__WEBPACK_IMPORTED_MODULE_1__["initPopup"])();
  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_init_accordeon__WEBPACK_IMPORTED_MODULE_2__["initAccordeon"])();
    Object(_modules_init_phone_mask__WEBPACK_IMPORTED_MODULE_3__["initPhoneMask"])();
  });
});
...
var initAccordeon = function initAccordeon() {
  ...
  accordeons.forEach(function (accordeon) {
    return accordeon.classList.remove('accordeon--no-js');
  });
  accordeons.forEach(function (accordeon) {
    var accordeonTitle = accordeon.querySelector('.accordeon__title');
    accordeonTitle.addEventListener('click', function () {
      var accordeonIsOpen = accordeon.classList.contains('accordeon--active') ? true : false;
      var accordeonPanel = accordeon.querySelector('.accordeon__content');
      accordeons.forEach(function (accordeonItem) {
      ...
      if (!accordeonIsOpen) {
        ...
        accordeonPanel.style.maxHeight = "".concat(accordeonPanel.scrollHeight, "px");
      }
    });
  });
};
...
var initPopup = function initPopup() {
  var autoFocusInput = document.querySelector('#modal-name');
